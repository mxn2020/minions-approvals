# Contributing to Minions Approvals

Thank you for your interest in contributing to Minions Approvals!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-approvals.git`
