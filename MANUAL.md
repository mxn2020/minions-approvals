# Manual Setup Steps for Minions Approvals
...
Go to **GitHub → mxn2020/minions-approvals → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-approvals` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-approvals-web`
- **GitHub repo**: `mxn2020/minions-approvals`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `approvals.minions.wtf`

### Documentation
- **Netlify site name**: `minions-approvals-docs`
- **GitHub repo**: `mxn2020/minions-approvals`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `approvals.minions.help`

### Blog
- **Netlify site name**: `minions-approvals-blog`
- **GitHub repo**: `mxn2020/minions-approvals`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `approvals.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `approvals.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `approvals.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `approvals.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-approvals/sdk`](https://www.npmjs.com/package/@minions-approvals/sdk)
- CLI: [`@minions-approvals/cli`](https://www.npmjs.com/package/@minions-approvals/cli)
...
Your package: [`minions-approvals`](https://pypi.org/project/minions-approvals/)
...
| Item | Value |
|------|-------|
| Project | `minions-approvals` |
| SDK (npm) | `@minions-approvals/sdk` |
| CLI (npm) | `@minions-approvals/cli` |
| Python (PyPI) | `minions-approvals` |
| GitHub | `github.com/mxn2020/minions-approvals` |
| Docs domain | `approvals.minions.help` |
| Blog domain | `approvals.minions.blog` |
| App domain | `approvals.minions.wtf` |
