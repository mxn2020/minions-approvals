...
/**
 * @minions-approvals/cli — CLI for Minions approvals
 *
...
import { customTypes } from '@minions-approvals/sdk';
...
program.name('approvals').description('Approval requests, human decisions, and immutable audit logs').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions approvals'));
    console.log(chalk.dim('Approval requests, human decisions, and immutable audit logs'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-approvals/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-approvals/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_approvals')}`);
